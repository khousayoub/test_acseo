...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ESsaiVM7WW', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('q4IpaOYoAB', 0, 'OT1l9XyLVro0bb2ev2sJAA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('C7O8IZ0wXI', 0, 'OT1l9XyLVro0bb2ev2sJAA', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dd1J7hzD-x', 0, 'OT1l9XyLVro0bb2ev2sJAA', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ACSEO_aeroport', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\AeroportBundle\\Entity'))), 'AeroportBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('AeroportBundle' => 'AeroportBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fbfe81c67a78d1bbb2904cefdafc486a1136557b24ca4ad4ccb39f476d0cea64');
    ...
    /**
     * Gets the 'form.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AeroportBundle\Form\user A AeroportBundle\Form\user instance
     */
    protected function getForm_UserService()
    {
        return $this->services['form.user'] = new \AeroportBundle\Form\user();
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('AeroportBundle\\Entity\\user');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('AeroportBundle\\Entity\\user');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('AeroportBundle\\Entity\\user');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('AeroportBundle\\Entity\\user');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'AeroportBundle\\Entity\\user');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\AeroportBundle/Resources/views'), 'Aeroport');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('dccefb2308231726b5aaaf1b5cb96d7267c6b801');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_PASSAGER' => array(0 => 'ROLE_USER'), 'ROLE_PILOTE' => array(0 => 'ROLE_USER'), 'ROLE_RESPONSABLE' => array(0 => 'ROLE_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AeroportBundle' => 'AeroportBundle\\AeroportBundle',
            ...
            'secret' => 'dccefb2308231726b5aaaf1b5cb96d7267c6b801',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'dccefb2308231726b5aaaf1b5cb96d7267c6b801',
            ...
            'fos_user.model.user.class' => 'AeroportBundle\\Entity\\user',
